const charset = d3.select("head")
								.append("meta")
								.attr("charset","utf-8")
const viewport = d3.select("head")
								.append("meta")
								.attr("name","viewport")
								.attr("width","device-width")
const title = d3.select("head")
								.append("title")
								.attr("id","title")
								.text("Bar Chart")
const stylesheet = d3.select("head")
								.append("link")
								.attr("href","style.css")
								.attr("rel","stylesheet")
								.attr("type","text/css")
...
.domain([new Date(1947, 1,1),new Date(2015, 7,1)])				 		.range([padding, h - padding])
...
.enter()
.append("rect")
.attr("x",(d, i) => ((i*(h/276))+(60)/*-(i*(60/275))*/-(i*((101+(9/11))/275))))
